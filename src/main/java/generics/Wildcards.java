...
//         holder.set(new Wildcards()); // Same warning
    ...
    //解释 Holder 与Holder<?> 是不同的； Similar to rawArgs(), but errors instead of warnings:
    static void unboundedArg(Holder<?> holder, Object arg) {
        // holder.set(arg); // Error: set(capture of ?) in Holder<capture of ?>
        //   cannot be applied to (Object)
        // holder.set(new Wildcards()); // Same error Can't do this;
        // don't have any 'T':
        // T t = holder.get();
    ...
    public static void main(String[] args) {
        ...
        //   wildSubtype(Holder<? extends T>,T) is applied to (Holder,Long)
